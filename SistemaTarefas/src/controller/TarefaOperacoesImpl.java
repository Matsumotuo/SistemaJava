    ...
    public void adicionarTarefa(TarefaController tarefaController, Scanner scanner) {
        ...
        switch (tipo) {
            case 1:
                ...
                System.out.print("Duração Estimada (em horas): ");
                int duracaoEstimada = scanner.nextInt();
                scanner.nextLine();
                System.out.print("É prática? (true/false): ");
                boolean isPratica = scanner.nextBoolean();
                scanner.nextLine();
                novaTarefa = new TarefaEstudo(tarefaController.listarTarefas().size() + 1, titulo, descricao,
                        dataTarefa, prioridade, status, disciplina, duracaoEstimada, isPratica);
                break;
            case 2:
