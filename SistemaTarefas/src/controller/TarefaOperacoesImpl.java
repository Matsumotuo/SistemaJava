...
public class TarefaOperacoesImpl implements TarefaOperacoes {
    ...
    public void adicionarTarefa(TarefaController tarefaController, Scanner scanner) {
        ...
        System.out.println("\n=== Adicionar Tarefa ===");
        System.out.print(
                "Tipo de Tarefa (1-Estudo, 2-Trabalho, 3-Lazer, 4-Pessoal, 5-Urgente, 6-Exercicios, 7-Financeiro, 8-Alimentação, 9-Datas comemorativas, 10-Projeto): ");
        ...
        TodasAsTarefas novaTarefa = null;
        switch (tipo) {
            case 1:
    ...
    public void editarTarefa(TarefaController tarefaController, Scanner scanner) {
        ...
        Tarefa tarefaAtualizada = new TodasAsTarefas(id, titulo, descricao, dataTarefa, prioridade, status);
    ...
    @Override
    public void exportarListaTarefasPorTipo(List<TodasAsTarefas> tarefas) {
    ...
    @Override
    public void exportarTodasAsTarefas(List<TodasAsTarefas> tarefas) {
